...
/*!
    \class StreamsModel
    \brief A list model for displaying list of streams for a Vimeo video.
    
    \ingroup models
    
    The StreamsModel is a list model used for displaying Vimeo video streams in a list view. 
...
/*!
    \brief Retrieves a list of streams for a Vimeo video.
