...
#ifndef QVIMEO_STREAMSMODEL_H
#define QVIMEO_STREAMSMODEL_H
...
class QVIMEOSHARED_EXPORT StreamsModel : public Model
{
    Q_OBJECT
    ...
    Q_PROPERTY(QVimeo::StreamsRequest::Error error READ error NOTIFY statusChanged)
